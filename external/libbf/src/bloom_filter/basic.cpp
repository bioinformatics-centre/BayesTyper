...
basic_bloom_filter::basic_bloom_filter(hasher h, bitvector b, bool partition)
    : hasher_(std::move(h)), bits_(std::move(b)), partition_(partition) {
}
...
bool basic_bloom_filter::partition() const {
